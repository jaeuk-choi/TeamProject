...
<body>
	...
	ArrayList<NoticeDTO> list = (ArrayList<NoticeDTO>) noticeDAO.getNoticeList(keyWord);
				...
				<div class="sidebar-menu">
					<ul class="menu">
						...
						<li class="sidebar-item  has-sub"><a href="#"
							...
							<ul class="submenu ">
								<li class="submenu-item "><a href="customer.jsp">회원 관리</a>
								</li>
						...
						<li class="sidebar-item  has-sub"><a href="#"
							...
							<ul class="submenu ">
								<li class="submenu-item "><a href="reservation.jsp">예약
										관리</a></li>
								<li class="submenu-item "><a href="reservation.jsp">기타</a>
								</li>
							</ul></li>
						...
						<li class="sidebar-item  has-sub"><a href="#"
							...
							<ul class="submenu ">
								<li class="submenu-item "><a href="service.jsp">서비스 관리</a>
								</li>
						...
						<li class="sidebar-item active has-sub"><a href="#"
							...
							<ul class="submenu ">
								<li class="submenu-item "><a href="notice_list.jsp">공지
										사항</a></li>
								<li class="submenu-item "><a href="notice_list.jsp">기타</a>
								</li>
							</ul></li>
					</ul>
				</div>
			...
			<div class="page-heading">
				...
				<div class="row form-group justify-content-end">
					<form method="post" action="notice_list.jsp"
						class="col-4 d-flex align-items-end" accept-charset="UTF-8">
						<input type="text" name="keyWord" placeholder="공지글 조회"
							class="form-control me-2"> <input type="submit"
							class="btn btn-outline-success" onclick="check()" value="조회">
					</form>
				</div>
											...
											<tbody>
												...
												<tr>
													<td class="text-bold-500"><a
														href="notice_list.jsp?notice_no=<%=noticeDTO.getNoticeNo()%>"><%=noticeDTO.getNoticeNo()%></a></td>
													<td class="text-bold-500"><a
														href="notice_view.jsp?notice_no=<%=noticeDTO.getNoticeNo()%>"><%=noticeDTO.getNoticeTitle()%></a></td>
													<td class="text-bold-500"><a
														href="notice_view.jsp?notice_no=<%=noticeDTO.getNoticeNo()%>"><%=noticeDTO.getNoticeReg()%></a></td>
												</tr>
												--%>
												<%--
												}
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination pagination-primary">
								...
								<li class="page-item"><a class="page-link"
									href="notice_list.jsp?nowPage=<%=(nowBlock - 1) * pagePerBlock%>&nowBlock=<%=nowBlock - 1%>">
								...
								<li class="page-item active"><a class="page-link"
									href="notice_list.jsp?nowPage=<%=i - 1%>&nowBlock=<%=nowBlock%>"><%=i%></a></li>
								--%>
								<%--
								}
								--%>
